...
def get_args_parser():
    ...
    parser.add_argument('--dataset_dir', type=str, help='path to dataset dir',
                        default='./datasets/visa_anomaly_detection/visa')
    parser.add_argument('--output_dir', type=str, help='path to output dir',
                        default='./datasets/AD_json/JSON_PATH/visa')
...
if __name__ == "__main__":
    ...
    for dataset_name in dataset_list:
        ...
        save_path_normal = os.path.join(args.output_dir, args.dataset_name, args.dataset_name+"_val_normal.json")
        save_path_outlier = os.path.join(args.output_dir, args.dataset_name, args.dataset_name + "_val_outlier.json")
